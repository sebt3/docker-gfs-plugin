...
require (
	github.com/Microsoft/go-winio v0.0.0-20180116223503-7da180ee92d8
	...
	github.com/docker/go-connections v0.0.0-20180228141015-7395e3f8aa16
	github.com/docker/go-plugins-helpers v0.0.0-20181025120712-1e6269c305b8
	github.com/docker/go-units v0.0.0-20180212134657-47565b4f722f
